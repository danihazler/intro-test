...
const BriefAndRules = props => {
	return (
		<main className="brief-and-rules side-wrapper flex bg-black">
			<CSSTransition
				in={true}
				appear={true}
				timeout={1000}
				classNames="brief-div"
			>
				<div className="content-wrapper bg-black">
					<div className="brief">
						...
						<div className="description">
							<p>
								Brave's situated in Parson's Green, which has its fair share of
								independent businesses and the famous White Horse pub (AKA 'The
								Sloany Pony'). Research the area, and find an independent
							...
							<p>
								Your response could be a poster, a strategic thought, a website,
								a film, something written on a chalkboard outside, a stunt that
								gets the business in a national newspaper, something the staff
								should do, a T-shirt, a dance craze, a tweet, a sing... you get
								the point, an idea can take many forms.
							</p>
						</div>
					</div>
					<button id="brief-btn" className="bg-black clean">
						Download
						<br />
						Brief
					</button>
